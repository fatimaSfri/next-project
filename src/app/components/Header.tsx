...
export default function Header() {
    ...
    return (
        <header className="bg-[#F8F9FA] h-[104px]  " dir="rtl">
            <div className="lg:container w-full  mx-auto h-full flex items-center justify-between">
                ...
                <div className="lg:w-8/12 max-lg:w-full max-sm:w-1/2  px-2 h-full flex">
                    ...
                    <button className="p-4 sm:hidden focus:outline-none cursor-pointer">
                        {/* <img src="/menu.svg" alt="Toggle menu" /> */}
                        <Image src="/images/menu.svg" alt="Toggle menu" width={24}
                            height={24} className="min-w-9" />
                    </button>
                    {/* <img src="/logo_dark.png" alt="not found" className="p-4"/> */}
                    {/* logo image */}
                ...
                <div className="lg:w-4/12 max-lg:w-6/12 max-sm:w-auto  px-2 h-full flex items-center lg:gap-8 max-lg:justify-between justify-end">
                    <div className="flex items-center max-sm:hidden">
                        {/* <img src="/phone.svg" alt="not found" className="p-4"/> */}
                    ...
                    <div>
                        {/* <img src="/profile.png" alt="not found" className="p-4"/> */}
                        {/* <Image src="/images/profile.png" alt="not found" width={24} height={24} /> */}
